...
pcbLength           = 65; // front to back (X axis)
pcbWidth            = 30; // side to side (Y axis)
pcbThickness        = 4; 
standoffHeight      = 4.0; //-- How much the PCB needs to be raised from the base to leave room for solderings and whatnot
standoffDiameter    = 4;
...
[
  ...
  ["Cam", 24, 25, 96, (pcbWidth-25)/2, pcbThickness, 10, 3, 2, standoffHoleSlack]
];
...
pcbStands = 
[
    [3.5, 3.5, yappAllCorners, yappCoordPCB],
    [14.5, 2, yappFrontLeft, yappCoordPCB, [yappPCBName, "Cam"]],
    [14.5, 2, yappFrontRight, yappCoordPCB, [yappPCBName, "Cam"]],
    [2, 2, yappFrontLeft, yappCoordPCB, [yappPCBName, "Cam"]],
    [2, 2, yappFrontRight, yappCoordPCB, [yappPCBName, "Cam"]]
    // [3.5, 3.5, standoffHeight, pcbThickness, yappAllCorners, yappCoordPCB, yappBaseOnly, yappHole]
];
...
connectors   =
[
    // [3.5, 3.5, 1, 2.7, 4.0, 5.0, 1.0, -1, yappAllCorners, yappCoordPCB, yappCountersink]
];
...
cutoutsBase = 
[
    // [0, 0, 2, 2, 0, yappRectangle, yappCoordPCB, [yappPCBName, "Cam"]]
    [(24-13-7.3), (25-12)/2, 12, 12, 0, yappRectangle, yappCoordPCB, [yappPCBName, "Cam"]]
];
...
cutoutsBack = 
[
    [10.5, 0, 13, 5, 0, yappRectangle]
];

cutoutsLeft =   
[
    [12.4-(14/2), 0, 14, 6, 0, yappRectangle],
    [41.4-(9/2), 0, 9, 6, 0, yappRectangle],
    [54-(9/2), 0, 9, 6, 0, yappRectangle]
];
...
snapJoins   =   
[
    [30, 5, yappLeft, yappRight],
    [90, 5, yappLeft, yappRight],
    [pcbWidth/2+2, 5, yappFront, yappBack],
    // [30, 5, yappFront, yappBack],
];
...
boxMounts =
[
    [[30, 0], 3.0, 5.0, 5.0, yappLeft],
    [[5, 0], 3.0, 5.0, 5.0, yappRight],
    [[pcbLength*2-12, 0], 3.0, 5.0, 5.0, yappLeft],
    [[pcbLength*2-12, 0], 3.0, 5.0, 5.0, yappRight],
];
